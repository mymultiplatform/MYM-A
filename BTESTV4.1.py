...
def perform_backtest():
    ...
    # Fixed trade times
    trade_times = [60, 300, 540]  # Day 10, Day 50, Day 90 trade times
    trade_index = 0

    while trade_index < len(trade_times):
        i = trade_times[trade_index]
        ...
        # Move to the next trade time
        trade_index += 1

        # Stop trading if balance is zero
        if balance <= 0:
            break
